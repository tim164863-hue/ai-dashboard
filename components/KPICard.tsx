...
export function KPICard({
  ...
  return (
    <div className="glass p-5 hud-corners hud-corners-bottom transition-all duration-200 hover:border-primary/30 border-animate">
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-2 flex items-baseline gap-1.5">
            ...
            {unit && <span className="text-[10px] text-text-muted font-mono uppercase">{unit}</span>}
          </div>
          {trend && trendValue && (
